...
[     3.5 Performing Digital IO Operations ](3.-common-task-reference/3.5-performing-digital-io-operations.md)

[     3.6 Performing an AD Autocalibration ](3.-common-task-reference/3.6-performing-an-ad-autocalibration.md)

[     3.7 Performing a DA Autocalibration ](3.-common-task-reference/3.7-performing-a-da-autocalibration.md)

[     3.8 AD Calibration Verification ](3.-common-task-reference/3.8-ad-calibration-verification.md)

[     3.9 DA Calibration Verification ](3.-common-task-reference/3.9-da-calibration-verification.md)

## [4. UD Function Reference](4.-ud-function-reference.md)

## [5. Data Type Reference](5.-data-type-reference.md)

## [6. Board Reference](6.-board-reference/)

[     6.1 Board Function Lists](6.-board-reference/6.1-board-function-lists.md)

[     6.2 Analog IO Ranges](6.-board-reference/6.2-analog-io-ranges.md)

## [7. Example Programs](7.-example-programs.md)

## [8. Error Codes](8.-error-codes.md)

## [9. Board Macros](9.-board-macros.md)

## [10. Index](untitled/)

## [11. Universal Driver APIs](11.-universal-driver-apis/)

## [12. Structure definitions](12.-structure-definitions/)
